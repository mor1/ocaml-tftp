...
(* OASIS_START *)
(* DO NOT EDIT (digest: e1fac17e355b15d2a6a9c2735e5b91fc) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Tftp"; "Tftp_config"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "tftp";
                      lib_findlib_containers = []
                   });
               Library
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\012F\128\003\134~,\2557\177N\152\004\217\207\026";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
