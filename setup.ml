...
(* OASIS_START *)
(* DO NOT EDIT (digest: 877ee99107f557f32e11d97ff567f4aa) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Install `tftp.wire` wire structure libs";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Install `tftp.server` server libs";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Tftp_wire"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "wire";
                      lib_findlib_containers = ["tftp"]
                   });
               Library
                 ({
                     cs_name = "tftp-server";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "gE)Â\020Jz\138v\158qØÎ×u\017";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
